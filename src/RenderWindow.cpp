...
RenderWindow::RenderWindow(const char *win_name, int w, int h)
  :window(nullptr), renderer(nullptr) {
    window = SDL_CreateWindow(win_name, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, w, h, SDL_WINDOW_SHOWN);
    if (!window) {
...
void RenderWindow::render(SDL_Texture *tex, SDL_Rect *clip, SDL_Rect *renderQuad) {
